...
class TestLinearWalk:
    def test_runs_every_step_in_order(self, store: FreshStore) -> None:
        runner = Recorder()
    ...
    def test_completion_is_persisted(self, store: FreshStore) -> None:
    ...
    def test_workflow_name_is_recorded_for_observers(self, store: FreshStore) -> None:
...
class TestGateBlocking:
    def test_walk_blocks_at_a_gate_with_no_input(self, store: FreshStore) -> None:
        runner = Recorder()
    ...
    def test_block_persists_position_status_and_schema(self, store: FreshStore) -> None:
...
class TestResume:
    ...
    def test_full_block_resume_complete_cycle(self, store: FreshStore) -> None:
        first = Recorder()
    ...
    def test_resume_reuses_the_recorded_return_value(self, store: FreshStore) -> None:
    ...
    def test_resuming_a_completed_scope_is_a_no_op(self, store: FreshStore) -> None:
    ...
    def test_a_still_blocked_gate_blocks_again(self, store: FreshStore) -> None:
    ...
    def test_scopes_are_independent(self, store: FreshStore) -> None:
...
class TestBranchStability:
    ...
    def test_an_unmatched_choice_ends_the_walk(self, store: FreshStore) -> None:
...
class TestFailure:
    def test_a_raising_step_fails_the_walk(self, store: FreshStore) -> None:
    ...
    def test_a_failed_step_is_retried_on_resume(self, store: FreshStore) -> None:
...
class TestFanOut:
    ...
    def test_both_branches_run(self, store: FreshStore) -> None:
        runner = Recorder()
    ...
    def test_a_join_runs_once(self, store: FreshStore) -> None:
    ...
    def test_a_join_waits_for_the_longer_branch(self, store: FreshStore) -> None:
    ...
    def test_a_loop_still_terminates(self, store: FreshStore) -> None:
