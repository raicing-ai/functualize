...
Commands available through the `func builtin run` sub-command. Read the **run
log** — every execution this project has performed, through any door:
...
`func builtin run list --scope <id>` is how the four are found.
